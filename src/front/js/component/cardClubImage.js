...
export const ClubImage = ({ name, estado, ciudad, id, index }) => {
    ...
    return (
        <>
            ...
            <div key={index} className="col-12 col-lg-4 d-flex flex-row justify-content-center align-items-center gap-2 p-5
         d-flex flex-row justify-content-center align-items-center ">
                <div className="card shadow p-3 mb-5 bg-body-tertiary rounded ">
                    ...
                    <div className="card-body ">
                        ...
                        <button onClick={() => submitPlaces(id)} className="cart-1 btn cart-2 d-grid gap-2 col-6 mx-auto fw-bolder btn btn-success">
