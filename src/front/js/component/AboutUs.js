            ...
            <div className="col-12 col-lg-6 col-xl-7">
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  <h2 className="h1 mb-3 text-white fw-bolder">AdminPal</h2>
                  <p className="lead fs-4 text-secondary mb-3 text-white">
                    Nuestra mision es darte la mejor comidad al momento de
                    buscar tu deporte favorito en el lugar donde mas te guste.
                  </p>
                  <div className="row gy-4 gy-md-0 gx-xxl-5X">
                    <div className="col-12 col-md-6">
                      <div className="d-flex">
                        ...
                        <div>
                          <h4 className="mb-3 text-white fw-bolder">Reserva</h4>
                          <p className="text-secondary mb-0">
                            Haz tus reservaciones, nosotros hacemos el resto.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-12 col-md-6">
                      <div className="d-flex">
                        ...
                        <div>
                          <h4 className="mb-3 text-white fw-bolder">
                            Administra
                          </h4>
                          <p className="text-secondary mb-0">
                            Administra tus espacios deportivos para tus
                            clientes.
                          </p>
                        </div>
                      </div>
