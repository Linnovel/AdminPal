          ...
          <div className="row gy-3 gy-md-0 align-items-md-center">
            ...
            <div className="col-md-7">
              <div className="card-body p-0">
                ...
                <p className="card-text lead">Mi roll principal fue el backend, usando mi experiencias en ingeniera y PHP logré aplicar las nuevas tecnologías aprendidas mediante el curso para hacer un trabajo optimo y alcanzar la meta para poder entregar este proyecto de manera optima, queremos llevar esta pagina al mercado actual y poder brindar este servicio al publico deportista y emprendedora.</p>
              </div>
            </div>
          </div>
        </div>
